...
Tap "Okay" to logout! 👉🚪`;
  ...
  return (
    <>
      <Nav />
      <div className='flex w-full bg-soft-milk min-h-screen'>
        <div className='w-full max-w-screen-sm sm:max-w-screen-md md:max-w-screen-lg lg:max-w-screen-xl mx-auto p-0'>
          <Routes>
